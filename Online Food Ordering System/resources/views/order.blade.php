            ...
            <div class="px-3 py-2">
                <div class="flex flex-row p-4 leading-normal border shadow-md hover:bg-gray-100">
                    <div class="p-2 w-1/5">
                        ...
                        <p class="mb-1"> Total: <span class="font-semibold capitalize"> TK{{number_format((float)$order->total, 2, '.', '')}} </span> </p>
                        ...
                        <div class="flex flex-col justify-between">
                            ...
                            <div class="flex flex-col items-center -white rounded-lg border shadow-md md:flex-row md:max-w-full hover:bg-gray-100">
                                ...
                                <div class="flex flex-col place-content-center px-4 py-3 leading-normal w-4/6">
                                    ...
                                    <p class="flex font-normal text-gray-700"> Price: <b>&nbsp;TK{{number_format((float)($food->price*$food->pivot->quantity), 2, '.', '')}} &ensp;</b> <span class="opacity-60"> [TK{{number_format((float)($food->price), 2, '.', '')}} per unit] <span> </p>
                                </div>
                            </div>
                            <div class="p-1"></div>
                            @endforeach
